...
define( 'NOTIFIER_THEME_NAME', 'Ability' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'ability' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', 'http://themes.swiftpsd.com/ability/notifier.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
